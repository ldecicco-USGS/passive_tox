...
```{r fig2, out.width = "500px"}
knitr::include_graphics(path = file.path(Sys.getenv("PASSIVE_PATH"), 
          "Figures", "Venn.png"))
```

Figure 2: Chemicals with information from ToxCast and ECOTOX used in the current study from passive samplers deployed at 69 sites within 62 tributaries of the Great Lakes, 2010-2014. [(n), number of chemicals represented in each category.]
