...
```
Figure 1: Map of sample sites and associated land cover.  Identification of site codes are presented in Figure 2 and in SI Table XX. 


```{r fig2, fig.width=9, fig.height=11}
source(file = "R/report/combo_plot2.R")
source(file = "create_triple_fig.R")
plot_out <- create_triple_fig(path_to_data)
plot_out
```
